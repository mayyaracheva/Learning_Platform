...
namespace Poodle.Services.Contracts
{
    public interface ISectionService
    {
        ...
        Task<SectionDto> CreateSection(SectionViewModel sectionDto, int courseId);
        Task<int> DeleteSection(int sectionId, User requester);
        Task<SectionDto> UpdateSection(int courseId, int sectionId, SectionViewModel sectionDto);
