    ...
    public partial class New : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2022, 6, 11, 12, 48, 57, 772, DateTimeKind.Utc).AddTicks(9109), "The course gives you a broad range of fundamental knowledge for all IT careers. Through a combination of lecture, hands-on labs, and self-study, you will learn how to install, operate, configure, and verify basic IPv4 and IPv6 networks. The course covers configuring network components such as switches, routers, and wireless LAN controllers; managing network devices; and identifying basic security threats. The course also gives you a foundation in network programmability, automation, and software-defined networking.", false, new DateTime(2022, 6, 11, 12, 48, 57, 772, DateTimeKind.Utc).AddTicks(9130), "img/course-1.jpg", "Implementing and Administering Solutions(CCNA)" },
                    { 7, 2, new DateTime(2022, 6, 11, 12, 48, 57, 772, DateTimeKind.Utc).AddTicks(9227), "A Guided Study Group offers you a 180-day journey of certification preparation. This approach offers a best-of-all-worlds path toward certification, with the flexibility and convenience of e-learning plus the motivation and accountability of working with a live coach. A mix of participants from various backgrounds and skill levels encourages collaboration.", false, new DateTime(2022, 6, 11, 12, 48, 57, 772, DateTimeKind.Utc).AddTicks(9229), "img/course-7.jpg", "Guided Study Group - CyberOps (GSG-CBROPS) 1.0" },
                    { 6, 2, new DateTime(2022, 6, 11, 12, 48, 57, 772, DateTimeKind.Utc).AddTicks(9221), "The course, Mulitcloud Automation and Orchestration with  CloudCenter Suite (CLDAO) v1.0 teaches you how to configure simplified orchestration and workflow automation that provides seamless integration within the Cisco® CloudCenter suite. Through lessons and hands-on experiences, you will learn to use the tools of the CloudCenter Suite to streamline business processes, automate tasks, and increase efficiency in business processes.", false, new DateTime(2022, 6, 11, 12, 48, 57, 772, DateTimeKind.Utc).AddTicks(9223), "img/course-6.jpg", "Multicloud Automation and Orchestration with CloudCenter Suite (CLDAO) 1.0" },
                    { 5, 2, new DateTime(2022, 6, 11, 12, 48, 57, 772, DateTimeKind.Utc).AddTicks(9205), "The course shows you how to implement, manage, and troubleshoot  Nexus® 9000 Series Switches in Cisco® NX-OS mode. Through expert instruction and extensive hands-on learning, you will learn how to deploy capabilities including Virtual Extensible LAN (VXLAN), Multiprotocol Label Switching (MPLS), high availability features, Intelligent Traffic Director, troubleshooting tools and techniques, NX-OS programmability features, and open interface technologies.", false, new DateTime(2022, 6, 11, 12, 48, 57, 772, DateTimeKind.Utc).AddTicks(9207), "img/course-5.jpg", "Nexus 9000 Switches in NX-OS Mode" },
                    { 10, 1, new DateTime(2022, 6, 11, 12, 48, 57, 772, DateTimeKind.Utc).AddTicks(9247), "Create a basic GitHub Action and use that action in a workflow.", false, new DateTime(2022, 6, 11, 12, 48, 57, 772, DateTimeKind.Utc).AddTicks(9249), "img/course-10.jpg", "Automate development tasks by using GitHub Actions" },
                    { 8, 2, new DateTime(2022, 6, 11, 12, 48, 57, 772, DateTimeKind.Utc).AddTicks(9232), "Through a combination of lessons and hands-on learning, you will practice operating, managing, and integrating Cisco DNA Center, programmable network infrastructure, and Cisco SD-Access fundamentals. You will learn how Cisco delivers intent-based networking across the campus, branch, WAN, and extended enterprise and ensures that your network is operating as intended.", false, new DateTime(2022, 6, 11, 12, 48, 57, 772, DateTimeKind.Utc).AddTicks(9234), "img/course-8.jpg", "Transforming to a Intent Based Network (IBNTRN) 1.0" },
                    { 4, 1, new DateTime(2022, 6, 11, 12, 48, 57, 772, DateTimeKind.Utc).AddTicks(9199), "The course shows you how to deploy and manage the  Nexus® 9000 Series Switches in Cisco Application Centric Infrastructure (Cisco ACI®) mode. You will learn how to configure and manage Cisco Nexus 9000 Series Switches in ACI mode, how to connect the Cisco ACI fabric to external networks and services, and the fundamentals of Virtual Machine Manager (VMM) integration. You will gain hands-on practice implementing key capabilities such as fabric discovery, policies, connectivity, VMM integration, and more.", false, new DateTime(2022, 6, 11, 12, 48, 57, 772, DateTimeKind.Utc).AddTicks(9201), "img/course-4.jpg", "Implementing Application Centric Infrastructure (DCACI)" },
                    { 3, 1, new DateTime(2022, 6, 11, 12, 48, 57, 772, DateTimeKind.Utc).AddTicks(9193), "The course shows you how to deploy, secure, operate, and maintain Unified Computing System™ (Cisco UCS®) B-series blade servers, Cisco UCS C-Series, and S-Series rack servers for use in data centers. You will learn how to implement management and orchestration software for Cisco UCS. You will gain hands-on practice: configuring key features of Cisco UCS, Cisco UCS Director, and Cisco UCS Manager; implementing UCS management software including Cisco UCS Manager and Cisco Intersight™; and more.", false, new DateTime(2022, 6, 11, 12, 48, 57, 772, DateTimeKind.Utc).AddTicks(9195), "img/course-3.jpg", "Configuring Unified Computing System (DCCUCS)" },
                    { 2, 1, new DateTime(2022, 6, 11, 12, 48, 57, 772, DateTimeKind.Utc).AddTicks(9186), "The course helps you prepare for DevNet Professional certification and for professional-level network automation engineer roles. You will learn how to implement network applications using Cisco® platforms as a base, from initial software design to diverse system integration, as well as testing and deployment automation. The course gives you hands-on experience solving real world problems using Cisco Application Programming Interfaces (APIs) and modern development tools.", false, new DateTime(2022, 6, 11, 12, 48, 57, 772, DateTimeKind.Utc).AddTicks(9188), "img/course-2.jpg", "Developing Applications Using Core Platforms and APIs (DEVCOR)" },
                    { 9, 1, new DateTime(2022, 6, 11, 12, 48, 57, 772, DateTimeKind.Utc).AddTicks(9238), "In this module, you'll learn how to take advantage of several virtualization services in Azure compute, which can help your applications scale out quickly and efficiently to meet increasing demands.", false, new DateTime(2022, 6, 11, 12, 48, 57, 772, DateTimeKind.Utc).AddTicks(9240), "img/course-9.jpg", "Microsoft Azure Fundamentals: Describe core Azure services" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 9, new DateTime(2022, 6, 11, 12, 48, 57, 770, DateTimeKind.Utc).AddTicks(6938), "Harriet.Dark@gmail.com", "Harriet", 9, false, "Dark", new DateTime(2022, 6, 11, 12, 48, 57, 770, DateTimeKind.Utc).AddTicks(6940), "hardiR789*", 2 },
                    { 1, new DateTime(2022, 6, 11, 12, 48, 57, 770, DateTimeKind.Utc).AddTicks(5026), "Ragnar.Lodbrock@abv.com", "Ragnar", 1, false, "Lodbrock", new DateTime(2022, 6, 11, 12, 48, 57, 770, DateTimeKind.Utc).AddTicks(5628), "adminADMIN123?", 1 },
                    { 2, new DateTime(2022, 6, 11, 12, 48, 57, 770, DateTimeKind.Utc).AddTicks(6794), "Jack.Richmond@yahoo.com", "Jack", 2, false, "Richmond", new DateTime(2022, 6, 11, 12, 48, 57, 770, DateTimeKind.Utc).AddTicks(6799), "johnJOHN123!", 1 },
                    { 3, new DateTime(2022, 6, 11, 12, 48, 57, 770, DateTimeKind.Utc).AddTicks(6805), "Jonathan.Davis@gmail.com", "Jonathan", 3, false, "Davis", new DateTime(2022, 6, 11, 12, 48, 57, 770, DateTimeKind.Utc).AddTicks(6806), "jondav123*", 2 },
                    { 4, new DateTime(2022, 6, 11, 12, 48, 57, 770, DateTimeKind.Utc).AddTicks(6809), "Ignatio.Italiano@gmail.com", "Ignatio", 4, false, "Italiano", new DateTime(2022, 6, 11, 12, 48, 57, 770, DateTimeKind.Utc).AddTicks(6811), "ignitalo123*", 2 },
                    { 5, new DateTime(2022, 6, 11, 12, 48, 57, 770, DateTimeKind.Utc).AddTicks(6814), "Reginald.Hargreeves@gmail.com", "Reginald", 5, false, "Hargreeves", new DateTime(2022, 6, 11, 12, 48, 57, 770, DateTimeKind.Utc).AddTicks(6816), "jamesonN123*", 2 },
                    { 6, new DateTime(2022, 6, 11, 12, 48, 57, 770, DateTimeKind.Utc).AddTicks(6825), "John.Hanes@gmail.com", "John", 6, false, "Hanes", new DateTime(2022, 6, 11, 12, 48, 57, 770, DateTimeKind.Utc).AddTicks(6827), "johnsonN123*", 2 },
                    { 7, new DateTime(2022, 6, 11, 12, 48, 57, 770, DateTimeKind.Utc).AddTicks(6830), "Horatio.Spanish@gmail.com", "Horatio", 7, false, "Spanish", new DateTime(2022, 6, 11, 12, 48, 57, 770, DateTimeKind.Utc).AddTicks(6831), "horspanP123*", 2 },
                    { 8, new DateTime(2022, 6, 11, 12, 48, 57, 770, DateTimeKind.Utc).AddTicks(6834), "Herbert.Spencer@gmail.com", "Herbert", 8, false, "Spencer", new DateTime(2022, 6, 11, 12, 48, 57, 770, DateTimeKind.Utc).AddTicks(6836), "hurspenM456!", 2 },
                    { 10, new DateTime(2022, 6, 11, 12, 48, 57, 770, DateTimeKind.Utc).AddTicks(6945), "Mario.Caruso@gmail.com", "Mario", 10, false, "Caruso", new DateTime(2022, 6, 11, 12, 48, 57, 770, DateTimeKind.Utc).AddTicks(6947), "marrob123!", 2 }
                });
