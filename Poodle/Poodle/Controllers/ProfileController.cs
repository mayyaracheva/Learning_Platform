...
namespace Poodle.Web.Controllers
{
    public class ProfileController : Controller
    {
        ...
        public async Task <IActionResult> Edit(UserUpdateDto userModel)
        {
            ...
            {                
                //check if user has a pic other than default in the folder and delete it to add the new one
                ...
                string defaultPath = Path.Combine(webHostEnvironment.WebRootPath, ConstantsContainer.DEFAULT_IMAGEURL);
